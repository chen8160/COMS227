...
public class GameTest3 {
	...
	public void testInitialConstructor1() {
		...
		String msg = "The game constructed with 5 max guesses should get 5 max wrong guesses";
		assertEquals(msg, 5, game.getMaxGuesses());
	}

	@Test
	public void testInitialConstructor2() {
	...
	public void testInitialSecretWord1() {
		...
		assertEquals(msg, testWord, game.getSecretWord());
	}
	...
	public void testWrongGuessCount3() {
		...
		Game game = new Game(testWord);
		guessChar(8, 'a', game);
		String msg = "A game with default 7 max wrong guesses, after guessing a eight times, with Hello, World! as secret phrase, the number of wrong guesses should be 7 ";
		assertEquals(msg, 7, game.numWrongGuesses());
	}

	@Test
	public void testWrongGuessCountSpace() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(1, ' ', game);
		String msg = "After guessing space once, with Hello, World! as secret phrase, the number of wrong guesses should be 1 ";
		assertEquals(msg, 1, game.numWrongGuesses());
	}

	@Test
	public void testWrongGuessCountAllGuessRight() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(1, 'H', game);
		guessChar(1, 'e', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing H, e, l, o, W, e, d, and r, with Hello, World! as secret phrase, the number of wrong guesses should be 0 ";
		assertEquals(msg, 0, game.numWrongGuesses());
	}

	@Test
	public void testLettersGuessedRepeatingGuessA() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(3, 'a', game);
	...
	@Test
	public void testLettersGuessedGuessLowerCaseAOnce() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		game.guessLetter('a');
	...
	@Test
	public void testLettersGuessedGuessUpperCaseAOnce() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		game.guessLetter('A');
		String msg = "After guessing a once, with Hello, World! as secret phrase, the letter guessed should be A";
	...
	@Test
	public void testLettersGuessedRepeatingGuessAAndB() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(3, 'a', game);
		guessChar(3, 'b', game);
	...
	@Test
	public void testLettersGuessedAllRightGuesses() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(1, 'H', game);
		guessChar(1, 'e', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing H, e, l, o, W, e, r, and d, with Hello, World! as secret phrase, the letter guessed should be HeloWedr";
		assertEquals(msg, "HeloWdr", game.lettersGuessed());
	}

	@Test
	public void testWonAllRightGuesses() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(1, 'H', game);
		guessChar(1, 'e', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing H, e, l, o, W, e, r, and d, with Hello, World! as secret phrase, won status should be true";
		assertEquals(msg, true, game.won());
	}

	@Test
	public void testWonNotExceedingMaxWrongGuesses() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(6, 'a', game);
		guessChar(1, 'H', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing a for 6 times and guessing H, e, l, o, W, d and r each once, with Hello, World! as secret phrase, won status should be true";
		assertEquals(msg, true, game.won());
	}

	@Test
	public void testWonExceedingMaxWrongGuesses() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(8, 'a', game);
		guessChar(1, 'H', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing a for 8 times and guessing H, e, l, o, W, d and r each once, with Hello, World! as secret phrase, won status should be false";
		assertEquals(msg, false, game.won());
	}

	@Test
	public void testGameOverNotExceedingMaxWrongGuesses() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(5, 'a', game);
		guessChar(1, 'H', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing a for 5 times and guessing H, e, l, o, W, d and r each once, with Hello, World! as secret phrase, game should be over";
		assertEquals(msg, true, game.gameOver());
	}

	@Test
	public void testGameOverExceedingMaxWrongGuesses() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(8, 'a', game);
		guessChar(1, 'H', game);
		...
		guessChar(1, 'd', game);
		guessChar(1, 'r', game);
		String msg = "After guessing a for 8 times and guessing H, e, l, o, W, d and r each once, with Hello, World! as secret phrase, game should be over";
		assertEquals(msg, true, game.gameOver());
	}

	@Test
	public void testGameOverNotExceedingMaxWrongGuesses2() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		guessChar(5, 'a', game);
		guessChar(1, 'H', game);
		...
		guessChar(1, 'W', game);
		guessChar(1, 'd', game);
		String msg = "After guessing a for 5 times and guessing H, e, l, o, W, and d each once, with Hello, World! as secret phrase, game should not be over";
		assertEquals(msg, false, game.gameOver());
	}

	@Test
	public void testGuessLetterWrongGuess1() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
	...
	@Test
	public void testGuessLetterWrongGuessCaseSensitive1() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		game.guessLetter('h');
		String msg = "After guessing h once, with Hello, World! as secret phrase, guessLetter should return false";
		assertEquals(msg, false, game.guessLetter('h'));
	}

	@Test
	public void testGuessLetterWrongGuessCaseSensitive2() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		game.guessLetter('E');
		String msg = "After guessing E once, with Hello, World! as secret phrase, guessLetter should return false";
		assertEquals(msg, false, game.guessLetter('E'));
	}

	@Test
	public void testGuessLetterWrongGuessExMark() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
	...
	@Test
	public void testGuessLetterWrongGuessSpace() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
	...
	@Test
	public void testGuessLetterRightGuess1() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
	...
	@Test
	public void testGuessLetterRightGuess2() {
		String testWord = "Hello, World!";
		Game game = new Game(testWord);
		String msg = "After guessing e once, with Hello, World! as secret phrase, guessLetter should return true";
		assertEquals(msg, true, game.guessLetter('e'));
	}
